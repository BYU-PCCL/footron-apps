...
// NOTE: this is a variation of Prim's algorithm that produces behavior more similar to the random traversal algorithm. Kinda cool but we won't add this to the wall. In any case, it's broken.
...
export default class PrimMaze extends Maze {
  ...
  insertSorted(nextCell, weight, deleteOld) {
    if (deleteOld) {
  ...
  insertPath(parent, child, weight) {
    ...
    } else if (weight > this.cellWeights[oldParent][child]) {
